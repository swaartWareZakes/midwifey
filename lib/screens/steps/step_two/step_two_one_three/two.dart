...
class StepTwoThreeTwo extends StatelessWidget {
  static String routeName = "/step_two_three_two";
  const StepTwoThreeTwo({ Key? key }) : super(key: key);
  ...
  Widget topCard(){
    return Text(
      "See weekly at the antenatal clinic",
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepTwoThreeThree.routeName);   
      },
      child: new Text(
