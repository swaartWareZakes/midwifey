...
class StepTwoOneTwo extends StatelessWidget {
  static String routeName = "/step_two_one_two";
  const StepTwoOneTwo({ Key? key }) : super(key: key);
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepTwoOneThree.routeName);   
      },
      child: new Text(
