...
class StepTwoOneOne extends StatelessWidget {
  static String routeName = "/step_two_one_one";
  const StepTwoOneOne({ Key? key }) : super(key: key);
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepTwoOneTwo.routeName);   
      },
      child: new Text(
