...
class StepTwoTwoOne extends StatelessWidget {
  static String routeName = "/step_two_two_one";
  const StepTwoTwoOne({ Key? key }) : super(key: key);
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepTwoTwoTwo.routeName);   
      },
      child: new Text(
