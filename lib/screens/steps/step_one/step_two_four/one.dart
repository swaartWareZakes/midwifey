...
class StepFourTwoOne extends StatelessWidget {
  static String routeName = "/step_four_two_one";
  const StepFourTwoOne({ Key? key }) : super(key: key);
  ...
  Widget topCard(){
    return Text(
      "Confirm diagnosis establish gestaonal age",
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepFourTwoTwo.routeName);   
      },
      child: new Text(
