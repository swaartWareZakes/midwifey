...
class StepFourTwoTwo extends StatelessWidget {
  static String routeName = "/step_four_two_two";
  const StepFourTwoTwo({ Key? key }) : super(key: key);
  ...
  Widget topCard(){
    return Text(
      "Invesgate for pre-eclampsia: \n Bloods \n Sonar for foetal evaluvaon \n  Urine MCS, P/Cr rao 24 h urine ",
  ...
  Widget bottomCard(context){
    return new GestureDetector(
      onTap: (){
          Navigator.pushNamed(context, StepFourTwoThree.routeName);   
      },
      child: new Text(
